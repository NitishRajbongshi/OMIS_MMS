...
class AssetBuildingDetail extends Model
{
    use HasFactory;
    ...
    /**
     * Building units belonging to this building
     */
    public function units()
    {
        return $this->hasMany(AssetBuildingUnitDetail::class, 'building_system_cd', 'building_system_cd');
    }
}
