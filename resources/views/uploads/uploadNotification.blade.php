...
@section('content')
    <section class="content">
        <div class="container-fluid mainBody py-3">
            ...
            <form action="{{ route('saveNotificationDetails') }}" method="post" id="frmUploadNotification"
                autocomplete="off" enctype="multipart/form-data">
                @csrf
                <fieldset class="border p-3 fl">
                    <input type="hidden" id="txtDeptCD" class="form-control" name="txtDeptCD" value="{{ $deptCd }}">

                    <legend class="w-auto px-2" style="font-size:14px;"><strong>Upload Notification</strong>
                    </legend>
                    ...
                    <div class="row form-1-box">
                        <div class="col-md-3">
                            <label for="txt_notification_title">Notification Title <span class="star">*</span></label>
                            <input type="text" id="txt_notification_title" class="form-control"
                                name="txt_notification_title">

                            @error('txt_notification_title')
                        ...
                        <div class="col-md-3">
                            <label for="notification_expiry_date">Notification Expiry Date <span
                                    class="star">*</span></label>
                            <input type="date" id="notification_expiry_date" class="custom-select form-control"
                                name="notification_expiry_date" />
                            @error('notification_expiry_date')
                                <div class="text-danger text-xs">
                                    {{ $message }}
                                </div>
                            @enderror
                    ...
                    <div class="row form-1-box">
                        <div class="col-md-6">
                            <label for="txt_notice_descr">Notification Description <span class="star">*</span></label>
                            <textarea type="text" id="txt_notice_descr" class="form-control" name="txt_notice_descr"></textarea>

                            @error('txt_notice_descr')
                                <div class="text-danger text-xs">
                                    {{ $message }}
                                </div>
                            @enderror
