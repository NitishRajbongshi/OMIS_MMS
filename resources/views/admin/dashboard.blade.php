...
@section('content')
    ...
    <div class="gis-dashboard">
        ...
        <div class="gis-heading">
            <div>
                <span class="gis-eyebrow">Geospatial Intelligence</span>
                <h1>Road & Infrastructure Map</h1>
                <p>Explore statewide road assets, structures and condition information.</p>
            </div>
            <div class="gis-status"><i></i> GIS services active</div>
        </div>
        <div class="gis-workspace row">
            <div class="col-12 p-1">
                <div class="gis-filterbar d-flex flex-wrap">
                    <div class="col-sm-12 col-md-4">
                        <h6><i class="fa fa-location-dot mr-1"></i>Division
                        </h6>
                    ...
                    <div class="col-sm-12 col-md-4">
                        <h6><i class="fa fa-road mr-1"></i>Road Asset</h6>
                    ...
                    <div class="col-sm-12 col-md-4">
                        <h6><i class="fa fa-layer-group mr-1"></i>Asset Layer</h6>
            ...
            <div class="col-sm-12 col-md-9 row">
                <div class="gis-map-card my-1 col-12">
                ...
                <div class="gis-detail-card my-1 py-2 col-12" id="sub-asset-sum-container">
                    <h6><i class="fa fa-circle-info mr-1"></i>Asset Details</h6>
            ...
            <div class="col-sm-12 p-1 col-md-3">
                <div class="p-1">
                    <h6 class="gis-summary-title"><i class="fa fa-chart-simple mr-1"></i>Road Summary</h6>
