    ...
    <div class="content-header mb-4">
        <div class="container-fluid">
            <ol class="breadcrumb float-sm-left text-sm">
                ...
                <li class="breadcrumb-item">View National Highway</li>
            </ol>
        </div>
    </div>
    <div id="loader">
        ...
        <div class="container-fluid mainBody py-2" style="border-radius: .2rem;">
            ...
            <h6 class="p-2 border border-primary text-light bg-primary">
                <span class="border border-primary text-light bg-primary text-sm text-uppercase">
                    LIST OF BRIDGES UNDER NAGALAND P W D (NH).
                </span>
            </h6>
            <div class="border border-primary px-1 rounded loaderContainer">
                <div class="row justify-content-between align-item-center">
                    <form id="wing_nh_bridge" class="mt-2 mb-1">
                        @csrf
                        <div class="row justify-content-center align-items-start">
                            <div class="col-sm-12 col-md-11 row">
                                ...
                                <div class="col-sm-6 col-md-3 d-flex align-items-center">
                                    <div class="me-1">
                                        <label for="bridgeType">Bridge</label>
                                    </div>
                                    <select style="width: 100%;" class="custom_select text-uppercase text-xs"
                                        name="bridgeType" id="bridgeType">
                                        <option value="null">All Types</option>
                                        @foreach ($bridgeTypes as $bridgeType)
                                            <option value={{ $bridgeType->bridge_type_cd }}>
                                                {{ $bridgeType->bridge_type_descr }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-6 col-md-3 d-flex align-items-center">
                                    <div class="me-1">
                                        <label for="constructionType">Construction</label>
                                    </div>
                                    <select style="width: 100%;" class="custom_select text-uppercase text-xs"
                                        name="constructionType" id="constructionType">
                                        <option value="null">All Types</option>
                                        @foreach ($constructionTypes as $constructionType)
                                            <option value={{ $constructionType->construction_type_cd }}>
                                                {{ $constructionType->construction_type_descr }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-6 col-md-3 d-flex align-items-center">
                                    ...
                                    <select style="width: 100%;" class="custom_select text-uppercase text-xs"
                                        name="foundationType" id="foundationType">
                                        <option value="null">All Types</option>
                                        @foreach ($foundationTypes as $foundationType)
                                            <option value={{ $foundationType->foundation_cd }}>
                                                {{ $foundationType->foundation_descr }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-6 col-md-3 d-flex align-items-center">
                                    <div class="me-1">
                                        <label for="pileType">Pile</label>
                                    </div>
                                    <select style="width: 100%;" class="custom_select text-uppercase text-xs"
                                        name="pileType" id="pileType">
                                        <option value="null">All Types</option>
                                        @foreach ($pileTypes as $pileType)
                                            <option value={{ $pileType->pile_type_cd }}>
                                                {{ $pileType->pile_type_descr }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3 d-flex align-items-center">
                                    <div class="me-1">
                                        <label for="rehabilitationYear">Rehabilitation Year</label>
                                    </div>
                                    <select style="width: 100%;" class="custom_select text-uppercase text-xs"
                                        name="rehabilitationYear" id="rehabilitationYear">
                                        <option value="null">All</option>
...
@push('scripts')
    ...
    <script>
        ...
        function getRoadByDivisionName(divisionName) {
            $.ajax({
                type: "GET",
                url: '/asset-management/nh-by-division-name',
                headers: {
