                        ...
                        <div class="row justify-content-center align-items-start">
                            <div class="col-sm-12 col-md-11 row">
                                ...
                                <div class="col-sm-6 col-md-3 d-flex align-items-center">
                                    ...
                                    <select style="width: 100%;" class="custom_select text-uppercase text-xs" name="pci"
                                        id="pci">
                                        <option value="null">All Values</option>
                                        <option value="0-10">0-5</option>
                                ...
                                <div class="col-sm-6 col-md-3 d-flex align-items-center">
                                    <div class="me-1">
                                        <label for="cracking">Cracking(%) </label>
                                    </div>
                                    <select style="width: 100%;" class="custom_select text-uppercase text-xs"
                                        name="cracking" id="cracking">
                                ...
                                <div class="col-sm-6 col-md-3 d-flex align-items-center">
                                    <div class="me-1">
                                        <label for="revelling">Ravelling(%) </label>
                                    </div>
                                    <select style="width: 100%;" class="custom_select text-uppercase text-xs"
                                        name="revelling" id="revelling">
                                        <option value="null">All</option>
                                        <option value="0-10">0-10</option>
                                        <option value="10-20">10-20</option>
                                        <option value="20-30">20-30</option>
                                ...
                                <div class="col-sm-6 col-md-3 d-flex align-items-center">
                                    <div class="me-1">
                                        <label for="shoving">Shoving(%)</label>
                                    </div>
                                    <select style="width: 100%;" class="custom_select text-uppercase text-xs"
                                        name="shoving" id="shoving">
                                        <option value="null">All</option>
                                        <option value="0-10">0-10</option>
                                        <option value="10-20">10-20</option>
                                        <option value="20-30">20-30</option>
                                ...
                                <div class="col-sm-6 col-md-3 d-flex align-items-center">
                                    <div class="me-1">
                                        <label for="potHoles">Pot Holes(%)</label>
                                    </div>
                                    <select style="width: 100%;" class="custom_select text-uppercase text-xs"
                                        name="potHoles" id="potHoles">
                                        <option value="null">All</option>
                                        <option value="0-10">0-10</option>
                                        <option value="10-20">10-20</option>
                                        <option value="20-30">20-30</option>
                                ...
                                <div class="col-sm-6 col-md-3 d-flex align-items-center">
                                    <div class="me-1">
                                        <label for="traficLight">Traffic Light?</label>
                                    </div>
                                    <select style="width: 100%;" class="custom_select text-uppercase text-xs"
                                        name="traficLight" id="traficLight">
                                        <option value="null">All</option>
                    ...
                    <div class="container-fluid mt-3" id="tableContent" style="display: none;">
                        ...
                        <table class="table-responsive text-xs table table-bordered table-striped user_list"
                            ...
                            <thead class="theader text-xs text-white" style="background-color:#417dbe">
                                ...
                                <th class="text-center" style="min-width: 5rem;">PCI Code</th>
                                <th class="text-center" style="min-width: 5rem;">PCI Length</th>
                                <th class="text-center" style="min-width: 5rem;">Chainage</th>
                                <th class="text-center" style="min-width: 5rem;">Cracking(%)</th>
                                <th class="text-center" style="min-width: 5rem;">Ravelling(%)</th>
                                <th class="text-center" style="min-width: 5rem;">Pot Holes(%)</th>
                                <th class="text-center" style="min-width: 5rem;">Shoving(%)</th>
                                <th class="text-center" style="min-width: 5rem;">Patching(%)</th>
                                <th class="text-center" style="min-width: 5rem;">Settlement(%)</th>
                                <th class="text-center" style="min-width: 5rem;">Rut Depth</th>
                                <th class="text-center" style="min-width: 5rem;">Traffic/Day</th>
                                <th class="text-center" style="min-width: 5rem;">Traffice Light?</th>
                                <th class="text-center" style="min-width: 5rem;">PCI Value</th>
                                <th class="text-center" style="min-width: 5rem;">Remarks</th>
                            </thead>
