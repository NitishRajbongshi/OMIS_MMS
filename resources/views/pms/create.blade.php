                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-sm-3">
                            ...
                            <select id="division_cd" name="division_cd" class="form-select form-select-sm"
                                ...
                                @if (session('userMapping')->office_type_cd === 'DO' || session('userMapping')->office_type_cd === 'SDO') selected disabled @endif required>
            ...
            <div class="card mb-2" id="upgradationSection" style="display: none;">
                ...
                <div class="card-body">
                        ...
                        <div class="nested-card p-2 mb-1">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3 myTooltip">
                                    <label id="startChainageLabel" class="form-label">Upgradation From Chainage
                                        (KM)</label>
                    ...
                    <div id="newRoadDetailsForm" class="row g-3">
                        <div class="col-md-4">
                            <label for="total_road_length" class="form-label fw-bold">
                                Total Road Length (Km)
                            </label>
                            <input type="text" id="total_road_length" name="total_road_length" class="form-control"
                                value="" readonly>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <label for="road_owner">Road Owner</label>
                    ...
                    <div class="card mt-3" id="priorityCard" style="display:none;">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-2">
                                Drag the roads to define the order in which the existing/ new roads will be connected/merged
                                to form the upgraded road.
                            </p>
                ...
                <div class="card-body">
                    ...
                    <div id="divNewRd">
                        <div class="row mb-1 pb-2">
                            ...
                            <div class="col-md-4">
                                <label for="road_category_new">Road Category</label>
                                <select id="road_category_new" class="custom-select form-control form-control-sm"
                            ...
                            <div class="col-md-4">
                                <label for="road_type_new">Road Type</label>
                                <select id="road_type_new" class="custom-select form-control form-control-sm"
                                    name="road_type_new">
                                    <option value="" disable selected hidden>Please Select</option>
                                    @foreach ($roadTypes as $roadType)
                                        <option value="{{ $roadType->rd_type_cd }}">
                            ...
                            <div class="col-md-4">
                                <label for="road_owner_new">Road Owner</label>
                                <select id="road_owner_new" class="custom-select form-control form-control-sm"
                                    name="road_owner_new">
                                    <option value="" disable selected hidden>Please Select</option>
                                    @foreach ($roadOwners as $roadOwner)
                                        <option value="{{ $roadOwner->owner_cd }}">{{ $roadOwner->owner_name }}
            ...
            <div id="draftSection">
                ...
                <div class="d-flex text-sm justify-content-end mb-2">
                    <button id="freezeBtnForNewProjectRoad" class="btn btn-sm btn-outline-info rounded-0 text-bold">
                        ...
                        Send selected project data for finalization
                    </button>
                </div>
                <div class="container-fluid border py-2">
                    <table class="table-responsive text-xs rounded-0 table table-bordered table-striped user_list"
                        ...
                        <thead class="theader text-white" style="background-color:#417DBE">
                            ...
                            <th class="text-center" style="min-width: 10rem;">Work Item</th>
...
@push('scripts')
    ...
    <script>
        ...
        document.getElementById('PmsSaveBtn').closest('form').addEventListener('submit', function(e) {
            ...
            if (projectType === 'UPG' && newRoadDetailsForm.style.display !== 'none') {

                const road_category = document.getElementById('road_category');
                const road_type = document.getElementById('road_type');
                const road_owner = document.getElementById('road_owner');

                let hasError = false;

                if (!road_category.value) {
                ...
                if (!road_owner.value) {
                    showError(road_owner, "Please select Road Owner");
                    hasError = true;
                }
            ...
            if (projectType === 'NEW') {
                ...
                const road_category_new = document.getElementById('road_category_new');
                const road_type_new = document.getElementById('road_type_new');
                const road_owner_new = document.getElementById('road_owner_new');


                let hasError = false;

                if (!slnewRdNew.value.trim()) {
                    showError(slnewRdNew, "Road Name is required");
                    hasError = true;
                }

                if (!rdLength.value || parseFloat(rdLength.value) <= 0) {
                    showError(rdLength, "Enter valid length");
                    hasError = true;
                }

                if (!road_category_new.value) {
                    showError(road_category_new, "Please select Road Category");
                    hasError = true;
                }

                if (!road_type_new.value) {
                    showError(road_type_new, "Please select Road Type");
                    hasError = true;
                }

                if (!road_owner_new.value) {
            ...
            if ((projectType === 'UPG' || projectType === 'NEW') && kmlFile && kmlCard.style.display !== 'none') {
