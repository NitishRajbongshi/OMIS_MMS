            ...
            <div class="card mb-2" id="maintenanceSection" style="display: none;">
                ...
                <div class="card-body">
                    <div class="row g-3 mb-2">
                        <div class="col-md-6">
                            <label class="form-label">Select Existing Vehicles:</label>
                            <input type="text" id="vehicleSearchMaint" class="form-control form-control-sm mb-2"
                                placeholder="Search vehicles...">

                            <div id="vehicleListMaint" class="border rounded p-2"
                                style="max-height:200px; overflow-y:auto;">

                            </div>
                            <span class="spanHide text-danger text-xs mt-2" id="vehicle_type_cd_error"></span>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Select Existing Equipments:</label>
                            <input type="text" id="equipmentSearchUpg" class="form-control form-control-sm mb-2"
                                placeholder="Search equipments...">


                            <div id="equipmentListMaint" class="border rounded p-2"
                                style="max-height:200px; overflow-y:auto;">

                            </div>
                            <span class="spanHide text-danger text-xs mt-2" id="equipment_type_cd_error"></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-2" id="upgradationSection" style="display: none;">
                ...
                <div class="card-body">
                    <div class="row g-3 mb-2">
                        <div class="col-md-6">
                            <label class="form-label">Select Existing Vehicles:</label>
                            <input type="text" id="vehicleSearchUpg" class="form-control form-control-sm mb-2"
                                placeholder="Search vehicles...">

                            <div id="vehicleListUpg" class="border rounded p-2"
                                style="max-height:200px; overflow-y:auto;">

                            </div>
                            <span class="spanHide text-danger text-xs mt-2" id="vehicle_type_cd_error_upg"></span>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Select Existing Equipments:</label>
                            <input type="text" id="equipmentSearchMaint" class="form-control form-control-sm mb-2"
                                placeholder="Search equipments...">

                            <div id="equipmentListUpg" class="border rounded p-2"
                                style="max-height:200px; overflow-y:auto;">

                            </div>
                            <span class="spanHide text-danger text-xs mt-2" id="equipment_type_cd_error_upg"></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        @if (!isset($project))
            <div id="draftSection">
                ...
                <div class="d-flex text-sm justify-content-end mb-2">
                    <button id="freezeBtnForNewProjectMechanical"
                        class="btn btn-sm btn-outline-danger rounded-0 text-bold">
                                    ...
                                    <td class="text-center">
                                        ...
                                        @elseif($draft->project_type_cd == 'UPG')
                                            @if ($hasUpgradationAssets)
                                                <button
                                                    ...
                                                    onclick="showModalNewAssetDetailMecha('{{ $draft->project_cd }}', 'upg')">
                                        ...
                                        @elseif($draft->project_type_cd == 'MTN')
                                            @if ($hasMaintenanceAssets)
                                                <button
                                                    class="text-sm outline-0 btn btn-xs btn-outline-secondary inline fw-bold rounded-0"
                                                    onclick="showModalNewAssetDetailMecha('{{ $draft->project_cd }}', 'maint')">
                                                    <i class="fas fa-eye text-xs"></i>
                                                </button>
                                            @else
                                                <span class="text-danger text-bold">NA</span>
