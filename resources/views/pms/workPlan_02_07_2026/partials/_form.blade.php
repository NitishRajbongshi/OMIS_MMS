    ...
    <div class="row g-3">
        ...
        <div class="col-sm-6 col-md-4">
            <label class="form-label" for="wid_precedence_item_cd">
                Work Plan Precedence <span class="text-danger">*</span>
            </label>
            <input type="number" name="wid_precedence_item_cd" id="wid_precedence_item_cd"
                class="form-control form-control-sm @error('wid_precedence_item_cd') is-invalid @enderror"
                value="{{ old('wid_precedence_item_cd', $currentItem->wid_precedence_item_cd ?? $workItem->item_cd) }}"
                step="1" min="0" />
