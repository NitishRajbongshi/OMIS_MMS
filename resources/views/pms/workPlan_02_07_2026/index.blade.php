                                ...
                                <tbody>
                                    @foreach ($workPlans as $index => $plan)
                                        <tr>
                                            ...
                                            <td>{{ $plan->wid_precedence_item_cd }}</td>
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6 col-md-4">
                                <label class="form-label" for="edit_wid_precedence_item_cd">
                                    Item Precedence <span class="text-danger">*</span>
                                </label>
                                <input type="number" name="wid_precedence_item_cd" id="edit_wid_precedence_item_cd"
                                    class="form-control form-control-sm" step="1" min="0" required />
                            </div>
                            <div class="col-sm-6 col-md-4">
