...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid mainBody py-3">
            ...
            <form action="{{ route('createCDWorks') }}" id="cd_work_form" method="post" autocomplete="off"
                            ...
                            <div id="box_wing_wall_fields" style="display: none;" class="col-md-12">
                                <div class="row form-1-box pb-2" style="background-color: #efeeee;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" min='0' step="0.001" placeholder="0.000" id="top_width"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" min='0' step="0.001" placeholder="0.000" id="bottom_width"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" min='0' step="0.001" placeholder="0.000" id="height1"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" min='0' step="0.001" placeholder="0.000" id="height2"
                                            class="form-control form-control-sm" name="height2" disabled
                                            value="{{ old('height2') }}" oninput="restrictDecimalPoints(event)" wire:>
